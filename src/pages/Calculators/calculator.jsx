...
//       <h1>Milling Calculator</h1>

//       <p>
//         Most mill owners calculate atta prices on a napkin, estimate conveyor specs from guesswork, and find out too late how much power they're wasting. ProMiller's Milling Calculator suite changes that — three precision tools, purpose-built for flour mill economics, accessible free from any phone or computer.
...
//     <div className="calculate-box">
//       <h4>Motor Sizing</h4>
//       <p>Drive motor power (kW/HP) — exact, not over-engineered.</p>
//     </div>
...
//       <p>Inclination factor and material angle of repose adjustment.</p>
//     </div>

//     <div className="calculate-box">
//       <h4>Drive Type</h4>
//       <p>Recommended drive type — direct, gearbox or VFD-controlled.</p>
//     </div>
...
//       <p>Alternative configurations for space-constrained layouts.</p>
//     </div>
//   </>
// )}
// {activeTab === "power" && (
...
//     <div className="calculate-box">
//       <h4>Baseline</h4>
//       <p>Current monthly power consumption from your existing setup.</p>
//     </div>

//     <div className="calculate-box">
//       <h4>Post-upgrade</h4>
//       <p>Expected consumption after WonderMill / iQuadra installation.</p>
//     </div>
...
//     <div className="calculate-box">
//       <h4>ROI View</h4>
//       <p>Payback scenario modelling — how long savings take to compound.</p>
//     </div>

//     <div className="calculate-box">
//       <h4>Config Comparison</h4>
//       <p>Compare 10-7 / 10-8 / 10-10 / 10-12 ProMiller configurations.</p>
//     </div>
//   </>
// )}
...
//       <li><strong>Screw conveyors</strong> — Horizontal and inclined wheat/flour transfer.</li>
//       <li><strong>Belt conveyors</strong> — Bulk grain and bag handling.</li>
//       <li><strong>Chain conveyors</strong> — Heavy-duty grain movement.</li>
//       <li><strong>Bucket elevators</strong> — Vertical grain and flour lifting.</li>
//       <li><strong>Pneumatic conveying</strong> — Dustless flour transfer.</li>
//     </ul>

//     <div className="highlight-note">
//       Most mills oversize conveyors by <strong>20–35%</strong>, paying for unused
//       capacity in every electricity bill. This calculator fixes that.
//     </div>
//     <div className="technical-info">
//       <h4>Technical Basis</h4>
//       <p>
//         Calculations follow <strong>CEMA (Conveyor Equipment Manufacturers
//         Association)</strong> standard engineering formulae, adapted for Indian
//         mill operating conditions — specifically the material bulk densities,
//         moisture ranges, and ambient temperatures relevant to wheat, atta,
//         maida, and bran.
//       </p>
//     </div>
...
//       <li>Target ProMiller configuration (10-7, 10-8, 10-10 or 10-12).</li>
//     </ul>
...
//       <p>
//         The Power Saving Calculator is not a marketing estimate — it is a decision tool. When a mill owner runs this before an eligibility check, the monthly saving figure often becomes the single most compelling number in the entire ProMiller conversation. It makes the zero-investment model self-explanatory.
...
//         Chakki atta mill owners, branded flour producers, bulk flour suppliers,
//         and any mill running an atta profit centre — including mills selling to
//         retailers, wholesalers, or direct consumers.
//       </p>

//       <div className="highlight-note">
//         Enter today's wheat rate, your power tariff, and your bran price —
//         the calculator gives you your atta floor price in under
...
//       <ul className="simple-list">
//         <li>Designed around chakki-atta economics — not generic food manufacturing models.</li>
//         <li>Separates fixed and variable costs the way a mill actually tracks them.</li>
//         <li>Accounts for bran credit, which most calculators ignore.</li>
//         <li>Updates dynamically — change wheat price, everything recalculates instantly.</li>
//         <li>Printable daily price sheet output for dealer and wholesale communication.</li>
//       </ul>
//     </section>
//   </>
// )}
...
//               <p>
//                 Generate accurate milling insights within seconds using
//                 ProMiller's engineering-backed calculators.
//               </p>
